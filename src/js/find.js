...
function schoolCard(school) {
  ...
  var studentLoan = parseFloat(
    school["latest.aid.students_with_any_loan"]
  ).toFixed(2);
...
function fetchSchoolDemo(searchQueryDemo) {
  ...
  var fetchThisDemo = [
    ...
    "&api_key=TH798jh0Un4LIFZvxWD5iyBwYKSDCpRLVZEWDdR5"
  ].join("");
  ...
  var singleSchoolDemo = [
    {
      ...
      race: "NHPI",
      number: (
        school["latest.student.demographics.race_ethnicity.nhpi"] * 100
      ).toFixed(2)
    },
...

    {
      ...
      race: "Asian",
      number: (
        school["latest.student.demographics.race_ethnicity.asian"] * 100
      ).toFixed(2)
    },

    {
      ...
      race: "Black",
      number: (
        school["latest.student.demographics.race_ethnicity.black"] * 100
      ).toFixed(2)
    },

    {
      ...
      race: "Unknown",
      number: (
        school["latest.student.demographics.race_ethnicity.unknown"] * 100
      ).toFixed(2)
    },

    {
      ...
      race: "White",
      number: (
        school["latest.student.demographics.race_ethnicity.white"] * 100
      ).toFixed(2)
    },

    {
      ...
      race: "Two or More",
      number: (
        school["latest.student.demographics.race_ethnicity.two_or_more"] * 100
      ).toFixed(2)
    },

    {
      ...
      race: "Hispanic",
      number: (
        school["latest.student.demographics.race_ethnicity.hispanic"] * 100
      ).toFixed(2)
    },
    {
      school: school["school.name"],
      race: "Aian",
      number: (
        school["latest.student.demographics.race_ethnicity.aian"] * 100
      ).toFixed(2)
    }
  ];
